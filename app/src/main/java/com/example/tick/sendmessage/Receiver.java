...
public class Receiver extends BroadcastReceiver {
    ...
    private MessageListenerr mMessageListener;
    @Override
    public void onReceive(Context context, Intent intent) {
       // Toast.makeText(context, "a message received",Toast.LENGTH_SHORT).show();
        ...
        mMessageListener.OnReceived();
    }
    public interface  MessageListenerr {
        public void OnReceived();
    }
    public void setOnReceivedMessageListener(MessageListenerr messageListener) {
